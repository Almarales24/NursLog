...
fun MedicacionScreen(
    ...
    Box(modifier = modifier.fillMaxSize()) {
        ...
        FloatingActionButton(
            onClick = { mostrarDialogoMedicamento = true },
            modifier = Modifier
    ...
    if (mostrarDialogoMedicamento) {
        MedicamentoDialog(
            viewModel = viewModel,
            onConfirm = { nombre, dosis, via, recomendacion, hora ->
                viewModel.crearMedicamento(nombre, dosis, via, recomendacion, hora)
                mostrarDialogoMedicamento = false
            },
            onDismiss = { mostrarDialogoMedicamento = false }
        )
    }
}